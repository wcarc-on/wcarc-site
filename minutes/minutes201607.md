...
New VE2s on the mesh. They are planning to try to mesh with the Hull hospital and then the YMCA.
...
* Graham (VE3GTC) mentioned some low cost LNAs used for satellite reception. He also showed the PC boards he is getting from OSH Park.
